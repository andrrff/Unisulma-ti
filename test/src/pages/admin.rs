...
impl Component for Admin {
    ...
    fn update(&mut self, msg: Self::Message) -> ShouldRender {
        ...
        Submit =>
        {
            // caller::remove_new_pc(JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), JsValue::from_str(""), vec![JsValue::from_str("")].into_boxed_slice(), vec![JsValue::from_str("")].into_boxed_slice(), JsValue::from_f64(self.props.id.clone().parse::<f64>().unwrap() - 1.0));
